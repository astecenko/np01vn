...
const
  ...
  csMaket = 'Mak42';
  csMaketName_42 = '42';
  csMaketName_P8 = 'P1'; // первоначально из-за ошибки постановщика был макет P8
  csRoute = 'Маршрут';
  csNote = 'Примечание';
  csOpenDoc = 'Открыт ';
  ...
  csTMSArh0 = 'NP01VN01_0.DB';
  csTMSArh1 = 'NP01VN01_1.DB';
  csTMSArh2 = 'NP01VN01_2.DB';
  ...
  //Ini-file
  csIniFileName = 'NP01VN.ini';
  csIniLocation = 'location';
  csIniService = 'service';
  csIniSheet = 'sheet';
  csIniOption = 'option';
  csIniTMSArhiv = 'tms_arhiv2';
  csIniChertArhiv = 'chert_arhiv';
  csIniTMSArhivDef =   '\\nevz\nevz\ASUP_Data1\BD-ASU\NET\NP01VN\';
  csIniChertArhivDef = '\\nevz\nevz\ASUP_Data1\BD-ASU\NET\NP01VN\NP01VN02\';
  csIniWorkname = 'workname';
  csIniLogDir = 'log_dir';
  csIniLogDirDef = '\\nevz\nevz\ASUP_Data1\PDO\Koa\Logs\';
  csIniTemplates = 'template';
  ...
  csDocColumn_15 = 'Кол-во материала';
  csDocColumn_16 = 'Наименование';
  csDocColumn_17 = 'Подразде-'#10'ление';
  csDocFileName_2 = '_Коды.xls';
  csDocFileName_3 = '_Коды_ТМЦ.xls';
  csDocPasw = 'rjcnz';
  csDocPrim = '"-';
  //-- Сообщения --
